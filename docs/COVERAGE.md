...
```
$ python -m relay_gate.cli coverage M:/AGENT_VAULT/PORTFOLIO/bench/external/mast/data/MAD_human_labelled_dataset.json --format mast
...
```
$ python -m relay_gate.cli coverage M:/AGENT_VAULT/PORTFOLIO/bench/external/arb/data/cleaned/webarena.555.json --format arb
...
```
$ python -m relay_gate.cli coverage M:/AGENT_VAULT/PORTFOLIO/bench/fake_done/trajectories/claude.jsonl --format claude-jsonl
